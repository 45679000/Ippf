...
#wdr-pivot-view #wdr-filter-view .wdr-filters-subview:before {
  ...
  border-color: transparent transparent #E5F6F5 transparent;
  right: 63px;
  top: -7px;
}
#wdr-pivot-view #wdr-filter-view .wdr-filters-subview:after {
...
#wdr-pivot-view #wdr-alert-view .wdr-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #018275;
}
#wdr-pivot-view #wdr-alert-view .wdr-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #018275;
}
...
#wdr-pivot-view .wdr-grid-layout div.wdr-cell {
  ...
  box-sizing: border-box;
  vertical-align: top;
  border-right: 1px solid #7eaca7;
  border-bottom: 1px solid #7eaca7;
  padding: 7px 4px;
  /*line-height: 22px;*/
}
...
#wdr-pivot-view .wdr-grid-layout #wdr-data-sheet {
  border-top: 1px solid #7eaca7;
  border-left: 1px solid #7eaca7;
}
...
/* ===== grid ===== */
/* ===== ui ===== */
#wdr-pivot-view .wdr-grid-layout .wdr-cell[data-n="even"]:not(.wdr-empty):not(.wdr-header) {
  background-color: #E5F6F5;
}
#wdr-pivot-view #wdr-rows-sheet .wdr-cell[data-n="odd"]:not(.wdr-empty) {
