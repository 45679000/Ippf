...
@theme-color-superdark: #006CAC;
@theme-color-midlight: #B3E2FC; //cdcdcd;
@theme-color-light: #BDE8FF; //#ebebeb;
@theme-color-superlight: #E5F6FF;
@theme-color-supersuperlight: rgb(240, 249, 255);
...
@grid-table-header-border-color: darken(@grid-table-header-color, 6%);
...
@grid-cell-border-color: #aeaecf; //#007cbf;
@grid-cell-border: 1px solid @grid-cell-border-color;
@grid-drilldown-link-text-color: @theme-color-supersuperlight;
@grid-selection-canvas-color: #3dfff947;
@grid-selection-canvas-border: 1px solid @theme-color-superdark;
@grid-auto-calculation-bar: @theme-color-superdark;
...
#wdr-pivot-view #wdr-rows-sheet {
    .wdr-cell[data-n="even"]:not(.wdr-empty) {
