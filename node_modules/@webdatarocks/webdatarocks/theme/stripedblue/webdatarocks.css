...
#wdr-pivot-view #wdr-alert-view .wdr-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #0277BD;
}
#wdr-pivot-view #wdr-alert-view .wdr-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #0277BD;
}
...
#wdr-pivot-view #wdr-rows-sheet .wdr-cell[data-n="even"]:not(.wdr-empty) {
