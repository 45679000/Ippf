...
@theme-color-midlight: #b9d998; //cdcdcd; //not used
@theme-color-light: #ebfada; //#ebebeb; //not used
...
@theme-base-color-light: #92c306;//#ebebeb;
...
@ui-border-color-light: @theme-color-midlight;//@theme-color-light;//#d5d5d5;
