...
#fm-pivot-view div.fm-alert-view .fm-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #868e94;
}
#fm-pivot-view div.fm-alert-view .fm-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #868e94;
}
...
#fm-pivot-view .fm-grid-layout .fm-sheet-selection-canvas {
  position: absolute;
  background-color: rgba(134, 142, 148, 0.2);
  pointer-events: none;
  box-sizing: border-box;
  border: 2px solid #868e94;
  z-index: 1;
}
