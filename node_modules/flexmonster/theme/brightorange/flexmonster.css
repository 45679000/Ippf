...
.fm-ui-arrow-up:before {
  ...
  border-color: transparent transparent #FDC9B3 transparent;
  top: -7px;
}
.fm-ui-arrow-up:after {
  width: 0px;
...
#fm-pivot-view div.fm-ui-datepicker .fm-ui-dp-header {
  ...
  padding: 10px;
  font-weight: bold;
  border-bottom: 1px solid #FDC9B3;
  position: relative;
}
...
#fm-pivot-view .fm-ui-toolbar-mobile {
  height: 48px;
  border-bottom: 1px solid #FB7841;
}
...
#fm-pivot-view .fm-fields-view-wrap button.fm-btn-open-fields {
  ...
  width: 44px;
  height: 44px;
  border-left: 1px solid #F56B30;
  border-bottom: 1px solid #F56B30;
  border-radius: 0;
  -webkit-box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);
  box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);
}
...
#fm-pivot-view .fm-aggregations-view .fm-arrow:before {
  ...
  border-color: transparent transparent transparent #FDC9B3;
}
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
  border-width: 4.5px 0 4.5px 5px;
  border-color: transparent transparent transparent #FFE9E0;
}
...
#fm-pivot-view div.fm-alert-view .fm-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #FB7841;
}
#fm-pivot-view div.fm-alert-view .fm-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #FB7841;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header-c {
  background-color: #FB7841;
  color: #fff;
  border-right: 1px solid #F46325;
  border-bottom: 1px solid #F46325;
}
...
#fm-toolbar-wrapper #fm-toolbar .fm-dropdown-content:before {
  content: '';
  border-color: transparent transparent #FDC9B3;
  border-style: outset outset solid;
  border-width: 6px;
  position: absolute;
  top: -12px;
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-colorpick-popup.fm-arrow-up:before {
  ...
  border-bottom: 6px solid #FDC9B3;
...
#fm-toolbar-wrapper .fm-left-scroll-button.fm-scroll-arrow {
  ...
  border-right: 20px solid #F56B30;
}
