...
.fm-ui-arrow-up:before {
  ...
  border-color: transparent transparent #007f72 transparent;
  top: -7px;
}
.fm-ui-arrow-up:after {
  width: 0px;
...
#fm-pivot-view div.fm-ui-dropdown .fm-ui-dropdown-list ul li {
  display: block;
  border-bottom: 1px solid #ABE8E2;
  padding: 9px 9px;
  cursor: pointer;
  position: relative;
}
...
#fm-pivot-view div.fm-ui-datepicker .fm-ui-dp-header {
  ...
  padding: 10px;
  font-weight: bold;
  border-bottom: 1px solid #007f72;
  position: relative;
}
...
#fm-pivot-view .fm-aggregations-view .fm-arrow:before {
  ...
  border-color: transparent transparent transparent #007f72;
}
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
  border-width: 4.5px 0 4.5px 5px;
  border-color: transparent transparent transparent #E5F6F5;
}
...
#fm-pivot-view .fm-grid-layout div.fm-grand-total-r {
  ...
  color: #111;
  border-right: 1px solid #9FD7D1;
  border-bottom: 1px solid #9FD7D1;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header.fm-grand-total-r {
  ...
  color: #fff;
  border-right: 1px solid #007166;
  border-bottom: 1px solid #007166;
}
...
#fm-pivot-view .fm-grid-layout .fm-filters div.fm-sheet-header {
  border-right: 1px solid #018275;
  border-bottom: 1px solid #018275;
  color: #CCE7E5;
  background-color: #00897B;
  text-align: center;
  line-height: 23px;
...
#fm-pivot-view .fm-grid-layout .fm-sheet-selection-canvas {
  position: absolute;
  background-color: #31ffe954;
  pointer-events: none;
  box-sizing: border-box;
  border: 1px solid #11bead;
  z-index: 1;
}
...
#fm-toolbar-wrapper #fm-toolbar .fm-dropdown-content:before {
  content: '';
  border-color: transparent transparent #007f72;
  border-style: outset outset solid;
  border-width: 6px;
  position: absolute;
  top: -12px;
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-colorpick-popup.fm-arrow-up:before {
  ...
  border-bottom: 6px solid #007f72;
...
#fm-toolbar-wrapper .fm-left-scroll-button.fm-scroll-arrow {
  ...
  border-right: 20px solid #018275;
}
