...
.fm-ui-arrow-up:before {
  ...
  border-color: transparent transparent #4492bd transparent;
  top: -7px;
}
.fm-ui-arrow-up:after {
  width: 0px;
...
#fm-pivot-view div.fm-ui-dropdown .fm-ui-dropdown-list ul li {
  display: block;
  border-bottom: 1px solid #4492bd;
  padding: 9px 9px;
  cursor: pointer;
  position: relative;
}
...
#fm-pivot-view .fm-ui-toolbar-mobile {
  height: 48px;
  border-bottom: 1px solid #0090DE;
}
...
#fm-pivot-view .fm-aggregations-view .fm-arrow:before {
  ...
  border-color: transparent transparent transparent #4492bd;
}
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
...
#fm-pivot-view div.fm-alert-view .fm-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #0090DE;
}
#fm-pivot-view div.fm-alert-view .fm-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #0090DE;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header-c {
  background-color: #0277BD;
  color: #fff;
  border-right: 1px solid #0271b4;
  border-bottom: 1px solid #0271b4;
}
...
#fm-pivot-view .fm-grid-layout .fm-sheet-selection-canvas {
  position: absolute;
  background-color: #b2fffd47;
  pointer-events: none;
  box-sizing: border-box;
  border: 1px solid #50b2d2;
  z-index: 1;
}
...
#fm-toolbar-wrapper #fm-toolbar .fm-dropdown-content:before {
  content: '';
  border-color: transparent transparent #4492bd;
  border-style: outset outset solid;
  border-width: 6px;
  position: absolute;
  top: -12px;
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-colorpick-popup.fm-arrow-up:before {
  ...
  border-bottom: 6px solid #4492bd;
