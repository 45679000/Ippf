...
.fm-ui-arrow-up:before {
  ...
  border-color: transparent transparent #A489D4 transparent;
  top: -7px;
}
.fm-ui-arrow-up:after {
  width: 0px;
...
#fm-pivot-view div.fm-ui-dropdown .fm-ui-dropdown-list ul li {
  display: block;
  border-bottom: 1px solid #D6CEE4;
  padding: 9px 9px;
  cursor: pointer;
  position: relative;
}
...
#fm-pivot-view div.fm-ui-datepicker .fm-ui-dp-header {
  ...
  padding: 10px;
  font-weight: bold;
  border-bottom: 1px solid #A489D4;
  position: relative;
}
...
#fm-pivot-view .fm-aggregations-view .fm-arrow:before {
  ...
  border-color: transparent transparent transparent #A489D4;
}
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
  border-width: 4.5px 0 4.5px 5px;
  border-color: transparent transparent transparent #D3C8E5;
}
...
#fm-pivot-view div.fm-alert-view .fm-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #7E57C2;
}
#fm-pivot-view div.fm-alert-view .fm-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #7E57C2;
}
...
#fm-pivot-view .fm-grid-layout div.fm-cell {
  ...
  vertical-align: top;
  border-right: none;
  border-bottom: 1px dashed #D6CEE4;
  padding: 7px 4px;
  line-height: normal;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header-r {
  ...
  color: #111;
  border-right: none;
  border-bottom: 1px dashed #D3C8E5;
}
#fm-pivot-view .fm-grid-layout div.fm-header-c {
  background-color: #7E57C2;
  color: #fff;
  border-right: none;
  border-bottom: 1px dashed #8D6FBF;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header.fm-grand-total-c {
  ...
  color: #fff;
  border-right: none;
  border-bottom: 1px solid #6338b0;
}
...
#fm-toolbar-wrapper #fm-toolbar .fm-dropdown-content:before {
  content: '';
  border-color: transparent transparent #A489D4;
  border-style: outset outset solid;
  border-width: 6px;
  position: absolute;
  top: -12px;
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-colorpick-popup.fm-arrow-up:before {
  ...
  border-bottom: 6px solid #A489D4;
...
#fm-toolbar-wrapper .fm-left-scroll-button.fm-scroll-arrow {
  ...
  border-right: 20px solid #8D6FBF;
}
...
#fm-pivot-view .fm-cols-sheet .fm-scroll-content div:last-child .fm-cell:not(.fm-empty).fm-grand-total {
  background-color: #673AB7;
}
