...
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
  ...
  border-color: transparent transparent transparent #FFF2ED;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header-r {
  ...
  color: #111;
  border-right: none;
  border-bottom: 1px solid #ECCFC3;
}
...
#fm-pivot-view .fm-grid-layout div.fm-grand-total-c {
  ...
  color: #111;
  border-right: none;
  border-bottom: 1px solid #F3D5C9;
}
...
#fm-pivot-view .fm-grid-layout div.fm-header.fm-total-r {
  ...
  color: #FFE0D3;
  border-right: none;
  border-bottom: 1px solid #E96F3C;
}
...
#fm-pivot-view .fm-data-sheet .fm-row .fm-cell.fm-total.fm-grand-total-c.fm-total-r:not(.fm-grand-total-r) {
  ...
  border-bottom: 1px solid #EDAD91;
}
