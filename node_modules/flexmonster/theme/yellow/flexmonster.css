...
.fm-ui-arrow-up:before {
  ...
  border-color: transparent transparent #FFE6A9 transparent;
  top: -7px;
}
.fm-ui-arrow-up:after {
  width: 0px;
...
#fm-pivot-view div.fm-ui-datepicker .fm-ui-dp-header {
  ...
  padding: 10px;
  font-weight: bold;
  border-bottom: 1px solid #dac696;
  position: relative;
}
...
#fm-pivot-view .fm-aggregations-view .fm-arrow:before {
  ...
  border-color: transparent transparent transparent #FFE6A9;
}
#fm-pivot-view .fm-aggregations-view .fm-arrow:after {
...
#fm-pivot-view div.fm-alert-view .fm-hexagon:before {
  left: 100%;
  border-left: 16.17px solid #F9A825;
}
#fm-pivot-view div.fm-alert-view .fm-hexagon:after {
  right: 100%;
  width: 0;
  border-right: 16.17px solid #F9A825;
}
...
#fm-pivot-view .fm-grid-layout .fm-sheet-selection-canvas {
  position: absolute;
  background-color: rgba(255, 241, 21, 0.22);
  pointer-events: none;
  box-sizing: border-box;
  border: 1px solid #dca827;
  z-index: 1;
}
...
#fm-toolbar-wrapper #fm-toolbar .fm-dropdown-content:before {
  content: '';
  border-color: transparent transparent #FFE6A9;
  border-style: outset outset solid;
  border-width: 6px;
  position: absolute;
  top: -12px;
...
#fm-toolbar-wrapper .fm-toolbar-ui .fm-colorpick-popup.fm-arrow-up:before {
  ...
  border-bottom: 6px solid #FFE6A9;
