...
FlexmonsterToolbar.prototype.icons = {
    ...
    "share": '<svg width="51" height="51" viewBox="0 0 51 51" xmlns="http://www.w3.org/2000/svg"><rect x="31.171" y="10.055" width="8.0442" height="8.0442" rx="4.0221" class="fill-background"/><rect x="10.055" y="21.116" width="8.0442" height="8.0442" rx="4.0221" class="fill-background"/><rect x="31.171" y="32.177" width="8.0442" height="8.0442" rx="4.0221" class="fill-background"/><path d="m35.194 9.5525c-2.4991 0-4.5249 2.0259-4.5249 4.5249 0 0.5791 0.1088 1.1328 0.3071 1.6418l-13.148 6.8869c-0.8133-1.2024-2.1897-1.9928-3.7506-1.9928-2.499 0-4.5249 2.0259-4.5249 4.5249s2.0259 4.5248 4.5249 4.5248c1.5609 0 2.9372-0.7903 3.7505-1.9926l13.148 6.8869c-0.1982 0.5089-0.307 1.0626-0.307 1.6417 0 2.499 2.0258 4.5248 4.5249 4.5248 2.499 0 4.5248-2.0258 4.5248-4.5248s-2.0258-4.5249-4.5248-4.5249c-1.561 0-2.9373 0.7904-3.7507 1.9928l-13.148-6.8869c0.1983-0.509 0.3071-1.0627 0.3071-1.6418s-0.1088-1.1328-0.3071-1.6417l13.148-6.8869c0.8134 1.2023 2.1897 1.9927 3.7506 1.9927 2.499 0 4.5248-2.0259 4.5248-4.5249s-2.0258-4.5249-4.5248-4.5249zm-3.5194 4.5249c0-1.9437 1.5757-3.5194 3.5194-3.5194 1.9436 0 3.5193 1.5757 3.5193 3.5194s-1.5757 3.5193-3.5193 3.5193c-1.9437 0-3.5194-1.5756-3.5194-3.5193zm-21.116 11.061c0-1.9437 1.5757-3.5194 3.5194-3.5194s3.5193 1.5757 3.5193 3.5194-1.5756 3.5193-3.5193 3.5193-3.5194-1.5756-3.5194-3.5193zm24.636 7.5414c-1.9437 0-3.5194 1.5757-3.5194 3.5194s1.5757 3.5193 3.5194 3.5193c1.9436 0 3.5193-1.5756 3.5193-3.5193s-1.5757-3.5194-3.5193-3.5194z" clip-rule="evenodd" class="fill-border" fill-rule="evenodd"/></svg>',
...
FlexmonsterToolbar.prototype.showFormatCellsDialog = function (measureName, measureAggregation) {
    ...
    var currentMeasureNames = undefined;
    ...
    function applyStringDataMode(isStringDataMode) {
        if (isStringDataMode) {
            thousandsSeparatorRow.classList.add("fm-hide");
            ...
            thousandsSeparatorRow.classList.remove("fm-hide");
    ...
    // thousands_separator
    var thousandsSepDropDown = this.createSelect(applyLabels(this.defaults.numberFormatting.thousandsSeparators));
    var thousandsSeparatorRow = this.createInputRow(Labels.thousands_separator, thousandsSepDropDown);
    group.appendChild(thousandsSeparatorRow);
...
FlexmonsterToolbar.prototype.showConditionalFormattingDialog = function (measureName) {
    ...
    addConditionBtn.setAttribute("type", "button");
...
FlexmonsterToolbar.prototype.createSelect = function (dataProvider, placeholder, allowMuliselect) {
    ...
    dropdown.classList.add("fm-ui");
    dropdown.classList.add("fm-ui-element");
    dropdown.classList.add("fm-ui-dropdown");

    var dropdownButton = document.createElement("a");
    dropdownButton.classList.add("fm-ui");
    dropdownButton.classList.add("fm-ui-element");
    dropdownButton.classList.add("fm-ui-toggle-btn");
    dropdownButton.classList.add("fm-ui-dropdown-btn");
    ...
    dropdownMenu.classList.add("fm-ui");
    dropdownMenu.classList.add("fm-ui-element");
    dropdownMenu.classList.add("fm-ui-dropdown-list");
    dropdownMenu.addEventListener("mouseleave", hide);
    dropdown.appendChild(dropdownMenu);

    var dropdownList = document.createElement("ul");
    dropdownList.id = this.guid();
    dropdownList.classList.add("fm-ui");
    dropdownList.classList.add("fm-ui-element");
    dropdownList.classList.add("fm-ui-list");
    ...
    function show() {
        if (_isOpen == false) {
            ...
            var offset = getOffset(dropdownButton);
            dropdownMenu.style.top = (offset.top + dropdownButton.clientHeight) + "px";
            dropdownMenu.style.left = offset.left + "px";
...
FlexmonsterToolbar.PopupManager.prototype.removePopup = function (popup) {
    ...
    if (popup != null && this.toolbar.toolbarWrapper.contains(popup.content)) {
        ...
        if (popup.prevActiveElement && popup.prevActiveElement.focus) {
            popup.prevActiveElement.focus({
                preventScroll: true
            });
        }
    }
